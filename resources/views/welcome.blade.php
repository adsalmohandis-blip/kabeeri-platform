            ...
            <article class="card dark">
                ...
                <div class="grid-2" style="margin-top:14px;">
                    @foreach ($developerFlow as $flow)
                        <div class="card" style="box-shadow:none;background:rgba(243,229,171,.10);border-color:rgba(243,229,171,.12);">
                            <h3>{{ $flow['title'] }}</h3>
                            <p>{{ $flow['text'] }}</p>
                        </div>
                    @endforeach
