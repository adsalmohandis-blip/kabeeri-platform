...
<head>
    ...
    <title>{{ __('kabeeri.brand.name') }} Command Center | لوحة جاهزية المنصة</title>
    <meta name="description" content="لوحة {{ __('kabeeri.brand.name') }} الرئيسية تعرض حالة التنفيذ، التراكر، قاعدة البيانات، Release Candidate، Next.js runtime، ومسارات الجمهور والمطورين.">
    ...
    <style>
        :root{--ink:#000000;--muted:#000000;--paper:#f0f0f0;--panel:rgba(240,240,240,.78);--panel-strong:rgba(240,240,240,.93);--line:rgba(0,0,0,.13);--night:#000000;--forest:#000000;--sage:#000000;--gold:#000000;--wheat:#f0f0f0;--clay:#000000;--sky:#000000;--danger:#000000;--good:#000000;--shadow:0 30px 90px rgba(0,0,0,.16);--soft:0 18px 50px rgba(0,0,0,.09);--radius:30px}
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;min-height:100vh;color:var(--ink);font-family:"IBM Plex Sans Arabic","Almarai",sans-serif;background:radial-gradient(circle at 8% 8%,rgba(0,0,0,.48),rgba(0,0,0,0) 25rem),radial-gradient(circle at 92% 4%,rgba(0,0,0,.38),rgba(0,0,0,0) 28rem),radial-gradient(circle at 70% 98%,rgba(0,0,0,.18),rgba(0,0,0,0) 34rem),linear-gradient(135deg,#f0f0f0 0%,#f0f0f0 52%,#000000 100%);background-attachment:fixed}body:before{content:"";position:fixed;inset:0;z-index:-1;opacity:.18;background-image:linear-gradient(rgba(0,0,0,.07) 1px,rgba(0,0,0,0) 1px),linear-gradient(90deg,rgba(0,0,0,.06) 1px,rgba(0,0,0,0) 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,#000000,rgba(0,0,0,0) 84%)}a{color:inherit;text-decoration:none}.shell{width:min(1420px,calc(100% - 34px));margin:0 auto;padding:18px 0 64px}.topbar{position:sticky;top:12px;z-index:20;display:flex;align-items:center;justify-content:space-between;gap:14px;padding:12px;border:1px solid var(--line);border-radius:28px;background:rgba(240,240,240,.72);backdrop-filter:blur(18px);box-shadow:0 14px 42px rgba(0,0,0,.08)}.brand{display:flex;align-items:center;gap:12px}.mark{width:54px;height:54px;display:grid;place-items:center;border-radius:19px;color:var(--paper);background:conic-gradient(from 220deg,#000000,#000000,#000000,#000000,#000000);font-family:Almarai,sans-serif;font-weight:800;font-size:22px}.brand strong{display:block;font-family:Almarai,sans-serif;font-size:16px}.brand span{display:block;color:var(--muted);font-size:13px}.topnav{display:flex;flex-wrap:wrap;gap:8px;justify-content:flex-end}.nav-link{display:inline-flex;align-items:center;justify-content:center;min-height:40px;padding:0 13px;border:1px solid rgba(0,0,0,.11);border-radius:999px;background:rgba(250,250,250,.45);font-size:13px;font-weight:800}.nav-link:hover{background:var(--paper);transform:translateY(-1px)}.hero{position:relative;overflow:hidden;margin-top:20px;border:1px solid var(--line);border-radius:46px;background:linear-gradient(145deg,rgba(240,240,240,.94),rgba(240,240,240,.74));box-shadow:var(--shadow)}.hero:before{content:"";position:absolute;width:430px;height:430px;inset-inline-start:-160px;top:-170px;border-radius:999px;background:repeating-linear-gradient(45deg,rgba(0,0,0,.15) 0 11px,rgba(0,0,0,0) 11px 25px);animation:floatA 19s ease-in-out infinite alternate}.hero-grid{position:relative;display:grid;grid-template-columns:minmax(0,1.08fr) minmax(370px,.92fr);gap:24px;padding:clamp(22px,3.2vw,42px)}.kicker,.eyebrow{display:inline-flex;align-items:center;gap:10px;width:fit-content;padding:9px 13px;border:1px solid rgba(0,0,0,.13);border-radius:999px;background:rgba(250,250,250,.55);color:#000000;font-weight:800;font-size:13px}.dot{width:10px;height:10px;border-radius:999px;background:var(--good);box-shadow:0 0 0 7px rgba(0,0,0,.14)}h1{max-width:980px;margin:22px 0 0;font-family:Almarai,sans-serif;font-size:clamp(30px,4.8vw,56px);line-height:1.02;letter-spacing:-2px}.lead{max-width:860px;margin:22px 0 0;color:var(--muted);font-size:clamp(14px,1.2vw,17px);line-height:1.95}.actions{display:flex;flex-wrap:wrap;gap:12px;margin-top:30px}.button{display:inline-flex;align-items:center;justify-content:center;min-height:52px;padding:0 22px;border:1px solid rgba(0,0,0,.15);border-radius:18px;font-weight:800;transition:transform .18s ease,box-shadow .18s ease}.button:hover{transform:translateY(-2px);box-shadow:0 16px 36px rgba(0,0,0,.14)}.primary{color:var(--paper);background:var(--night)}.secondary{background:rgba(250,250,250,.60)}.ghost{background:rgba(240,240,240,.72);color:var(--forest)}.command-card{padding:24px;border-radius:32px;color:var(--paper);background:linear-gradient(160deg,rgba(0,0,0,.97),rgba(0,0,0,.94) 58%,rgba(0,0,0,.92));box-shadow:0 24px 64px rgba(0,0,0,.22)}.command-card h2{margin:0;font-family:Almarai,sans-serif;font-size:20px}.command-card p{margin:10px 0 18px;color:rgba(240,240,240,.76);line-height:1.8}.hero-metrics{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.hero-metric{padding:17px;border-radius:22px;background:rgba(240,240,240,.09);border:1px solid rgba(240,240,240,.13)}.hero-metric span{display:block;color:rgba(240,240,240,.66);font-size:12px;font-weight:800;text-transform:uppercase}.hero-metric strong{display:block;margin-top:7px;font-family:Almarai,sans-serif;font-size:20px}.hero-metric small{color:rgba(240,240,240,.72)}.section{margin-top:24px}.section-title{display:flex;justify-content:space-between;align-items:end;gap:18px;margin-bottom:16px}.section-title h2{margin:0;font-family:Almarai,sans-serif;font-size:clamp(22px,2.8vw,34px);letter-spacing:-.9px}.section-title p{max-width:720px;margin:0;color:var(--muted);line-height:1.85}.grid-2{display:grid;grid-template-columns:repeat(2,1fr);gap:16px}.grid-3{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.grid-4{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}.card{border:1px solid var(--line);border-radius:var(--radius);background:var(--panel);box-shadow:var(--soft);padding:24px}.card h3{margin:0 0 10px;font-family:Almarai,sans-serif;font-size:20px}.card p{margin:0;color:var(--muted);line-height:1.82}.tag{display:inline-flex;margin-bottom:14px;padding:8px 11px;border-radius:999px;background:rgba(0,0,0,.12);color:var(--forest);font-size:12px;font-weight:800}.dark{color:var(--paper);background:linear-gradient(145deg,#000000,#000000)}.dark p,.dark li,.dark small{color:rgba(240,240,240,.76)}.stat-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:12px}.stat{padding:20px;border:1px solid var(--line);border-radius:26px;background:rgba(240,240,240,.68);box-shadow:var(--soft)}.stat span{display:block;color:var(--muted);font-size:12px;font-weight:800}.stat strong{display:block;margin-top:8px;font-family:Almarai,sans-serif;font-size:20px}.stat small{display:block;margin-top:4px;color:var(--muted)}.good strong{color:var(--good)}.warn strong{color:var(--clay)}.danger strong{color:var(--danger)}.version-list{display:grid;gap:10px}.version-row{display:grid;grid-template-columns:82px 1fr 92px 110px;gap:12px;align-items:center;padding:13px 14px;border-radius:18px;background:rgba(250,250,250,.48);border:1px solid rgba(0,0,0,.07)}.version-row strong{font-family:Almarai,sans-serif}.version-row small{color:var(--muted)}.bar{height:10px;border-radius:999px;background:rgba(0,0,0,.09);overflow:hidden}.bar span{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,var(--forest),var(--gold))}.pill{display:inline-flex;justify-content:center;align-items:center;min-height:32px;padding:0 10px;border-radius:999px;background:rgba(0,0,0,.13);color:var(--good);font-weight:800;font-size:12px}.pill.pending{background:rgba(0,0,0,.13);color:#000000}.pill.review{background:rgba(0,0,0,.16);color:#000000}.data-group{display:flex;flex-direction:column;gap:12px}.group-head{display:flex;justify-content:space-between;gap:12px;align-items:center}.group-head strong{font-family:Almarai,sans-serif;font-size:21px}.group-head span{color:var(--muted)}.table-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:8px}.table-chip{display:flex;justify-content:space-between;gap:10px;padding:10px 11px;border-radius:14px;background:rgba(250,250,250,.48);font-size:13px}.table-chip b{font-family:Almarai,sans-serif}.route-list,.history-list,.doc-list,.check-list{display:grid;gap:10px;margin-top:14px}.route-list a,.doc-list div,.history-item,.check-item{display:flex;justify-content:space-between;gap:14px;align-items:center;padding:12px 14px;border-radius:16px;background:rgba(250,250,250,.48);border:1px solid rgba(0,0,0,.07);font-weight:800}.history-item{display:block;font-weight:500}.history-item strong{font-weight:800}.history-item p{margin:6px 0 0;font-size:13px}.dark .route-list a,.dark .check-item{background:rgba(240,240,240,.10);border-color:rgba(240,240,240,.12)}.price{font-family:Almarai,sans-serif;font-size:20px;margin:12px 0}.price small{font-size:13px;color:var(--muted)}.step{position:relative;overflow:hidden;min-height:220px}.step:after{content:attr(data-step);position:absolute;inset-inline-end:18px;bottom:6px;color:rgba(0,0,0,.06);font-family:Almarai,sans-serif;font-size:52px;font-weight:800}.step small{color:var(--clay);font-weight:800}.chips{display:flex;flex-wrap:wrap;gap:8px;margin-top:14px}.chip{padding:8px 10px;border-radius:999px;background:rgba(250,250,250,.55);font-size:12px;font-weight:800}.next-box{margin-top:10px;padding:12px;border-radius:16px;background:rgba(0,0,0,.09);color:#000000;font-size:13px;line-height:1.7}.final{margin-top:24px;padding:clamp(26px,5vw,50px);border-radius:40px;border:1px solid var(--line);background:linear-gradient(145deg,rgba(240,240,240,.92),rgba(240,240,240,.78));box-shadow:var(--shadow);text-align:center}.final h2{margin:0;font-family:Almarai,sans-serif;font-size:clamp(24px,3.2vw,38px);line-height:1.15}.final p{max-width:850px;margin:18px auto 26px;color:var(--muted);line-height:1.9;font-size:16px}@keyframes floatA{from{transform:translate3d(0,0,0) rotate(0)}to{transform:translate3d(42px,30px,0) rotate(10deg)}}@media(max-width:1180px){.hero-grid,.grid-2{grid-template-columns:1fr}.stat-grid{grid-template-columns:repeat(3,1fr)}.grid-3,.grid-4{grid-template-columns:repeat(2,1fr)}}@media(max-width:760px){.shell{width:min(100% - 22px,1420px);padding-top:12px}.topbar{position:static;flex-direction:column;align-items:stretch;border-radius:22px}.topnav{justify-content:stretch}.nav-link{flex:1}.hero{border-radius:30px}.hero-grid{grid-template-columns:1fr;padding:24px}h1{letter-spacing:-1.1px}.hero-metrics,.stat-grid,.grid-3,.grid-4,.table-grid{grid-template-columns:1fr}.section-title{flex-direction:column;align-items:start}.version-row{grid-template-columns:64px 1fr}.version-row .pill,.version-row small{text-align:right;justify-content:flex-start}.route-list a,.doc-list div,.check-item{align-items:flex-start;flex-direction:column}}
    </style>
</head>
<body>
    <div class="shell">
        <header class="topbar">
            <a class="brand" href="/">
                ...
                <div>
                    <strong>{{ __('kabeeri.brand.name') }} Command Center</strong>
            ...
            <article class="card dark">
                ...
                <div class="grid-2" style="margin-top:14px;">
                    @foreach ($developerFlow as $flow)
                        <div class="card" style="box-shadow:none;background:rgba(240,240,240,.10);border-color:rgba(240,240,240,.12);">
                            <h3>{{ $flow['title'] }}</h3>
                            <p>{{ $flow['text'] }}</p>
                        </div>
                    @endforeach
