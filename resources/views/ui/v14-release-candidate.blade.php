...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{margin:0;min-height:100vh;color:var(--ink);background: #f0f0f0;font-family:"IBM Plex Sans Arabic","Almarai",sans-serif}body:before{content:"";display:none}a{color:inherit;text-decoration:none}.shell{width:min(100% - 32px,1360px);margin:0 auto;padding:18px 0 74px}.topbar{position:sticky;top:14px;z-index:20;display:flex;align-items:center;justify-content:space-between;gap:14px;padding:14px;border:1px solid rgba(0,0,0,.13);border-radius:999px;background:rgba(250,250,250,.76);box-shadow:0 18px 64px rgba(0,0,0,.12);backdrop-filter:blur(22px)}.brand{display:flex;align-items:center;gap:12px}.brand-mark{display:grid;place-items:center;width:48px;height:48px;border-radius:17px;color:var(--paper);background: #000000;font-weight:900;letter-spacing:-.1em}.brand small{display:block;margin-top:2px;color:var(--soft);font-size:12px}.nav,.actions,.chips{display:flex;flex-wrap:wrap;gap:8px}.nav a,.button,.chip,.pill{display:inline-flex;align-items:center;justify-content:center;border-radius:999px;font-weight:900}.nav a{padding:10px 13px;color:rgba(0,0,0,.72);font-size:13px}.button{min-height:42px;padding:10px 16px;border:1px solid var(--line);background:rgba(240,240,240,.72);color:var(--forest)}.button.primary{border-color:rgba(0,0,0,0);color:var(--paper);background: #000000}.hero,.section,.card{border:1px solid var(--line);background:rgba(240,240,240,.72);box-shadow:0 14px 42px rgba(0,0,0,.08)}.hero{overflow:hidden;margin-top:22px;border-radius:46px;box-shadow:var(--shadow)}.hero-grid{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(330px,.92fr);gap:24px;padding:34px}h1,h2,h3,.brand strong{letter-spacing:-.045em}h1{margin:18px 0 16px;font-size:clamp(30px,4.8vw,54px);line-height:.98}.hero p,.section-title p,.card p,.route-row span{line-height:1.82;color:var(--soft)}.eyebrow,.chip{min-height:30px;padding:6px 11px;border:1px solid rgba(0,0,0,.18);color:var(--forest);background:rgba(240,240,240,.76);font-size:12px}.section{margin-top:22px;padding:30px;border-radius:34px}.section.dark{color:var(--paper);border-color:var(--white-line);background: #000000}.dark p,.dark span{color:rgba(240,240,240,.72)}.section-title{display:flex;align-items:end;justify-content:space-between;gap:18px;margin-bottom:18px}.section-title h2{margin:8px 0 0;font-size:clamp(22px,2.8vw,32px);line-height:1.08}.grid-2,.grid-3,.grid-4{display:grid;gap:14px}.grid-2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid-3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid-4{grid-template-columns:repeat(4,minmax(0,1fr))}.card{padding:22px;border-radius:26px}.card h3{margin:11px 0 9px;font-size:21px}.metric{margin-top:12px;color:var(--forest);font-size:20px;font-weight:900}.pill{min-height:30px;padding:6px 11px;font-size:12px}.pill.ready{color:#000000;background:rgba(0,0,0,.13);border:1px solid rgba(0,0,0,.2)}.pill.pending{color:#000000;background:rgba(0,0,0,.13);border:1px solid rgba(0,0,0,.22)}.route-row{display:grid;grid-template-columns:170px minmax(0,1fr) 110px;gap:12px;align-items:center;padding:12px 14px;border-bottom:1px solid var(--line)}.route-row:last-child{border-bottom:0}.route-list{overflow:hidden;border:1px solid var(--line);border-radius:24px;background:rgba(240,240,240,.6)}code{direction:ltr;display:block;border-radius:16px;background:#000000;color:#f0f0f0;padding:12px 14px}.footer{display:flex;justify-content:space-between;gap:12px;margin-top:26px;padding:24px 4px 0;color:rgba(0,0,0,.62);font-size:13px}
